...
class FileGenerator {
	...
	public function getClassPath() {
		...
		if (isset($this->baseDir)) {
			$baseDir = trim(str_replace('\\', '/', $this->baseDir), '/') . '/';
			$class = $baseDir . $name;
		}
	...
	public function resolveFilePath() {
		return Framework::path($this->getFilePath());
	}
	...
	public function writeFile($content, OutputInterface $out = null) {
		...
		if (isset($out)) {
			$out->writeln('<fg=green>[✓]</> create ' . $this->getFilePath());
		}
	}
	...
	public function writeClassFile($content, OutputInterface $out = null) {
		...
		if (isset($out)) {
			$out->writeln('<fg=green>[✓]</> create ' . $this->getClassPath());
		}
	}
